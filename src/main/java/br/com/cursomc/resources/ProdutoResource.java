...
public class ProdutoResource {
			...
			@RequestParam(value = "direction", defaultValue = "ASC")String direction)
	{
		...
		List<Integer> idsDecoded = URL.decodeIntList(categorias);
		
		Page<Produto> list = produtoService.search(nomeDecoded, idsDecoded,page, linesPerPage, orderBy, direction);
